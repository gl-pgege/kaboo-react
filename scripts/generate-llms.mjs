...
const PAGES = "https://gl-pgege.github.io/@pgege/kaboo-react/";
...
llms +=
  ...
  "endpoint. It ships two barrels (`kaboo-react`, `@pgege/kaboo-react/copilotkit`) and " +
  "a `@pgege/kaboo-react/styles.css` stylesheet.\n\n";
